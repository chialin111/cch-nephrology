      ...
      <div className="container mx-auto px-6 py-16 md:py-24 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="hidden md:flex justify-center items-center flex-shrink-0">
            <div className="w-36 h-36 md:w-48 md:h-48 bg-white/10 rounded-full backdrop-blur-md border-[6px] border-white/20 flex items-center justify-center shadow-2xl transform rotate-3 hover:rotate-6 transition-transform duration-500 overflow-hidden">
              <img
                src={cchLogo}
                alt="CCH Logo"
